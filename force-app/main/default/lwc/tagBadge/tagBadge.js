...
import ICON_VARIANT from "@salesforce/schema/Tag_Anything__c.Icon_Variant__c";
...
export default class TagBadge extends LightningElement {
    ...
    get iconVariant() {
        if (!isNullOrWhiteSpace(this.recordId)) {
            return getFieldValue(this.wiredRecord.data, ICON_VARIANT);
        }
        return this.inboundVariant;
    }
